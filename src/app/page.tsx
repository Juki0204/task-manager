      ...
      {/* <div className="flex flex-wrap gap-4">
        <div className="w-1/2 rounded-xl border-2 border-neutral-600 bg-neutral-800 p-4 text-white tracking-wide">
          <div className="flex mb-1 justify-between">
            <h3 className="font-bold text-lg truncate flex gap-1 items-center"><MdMailOutline />おまかせ祭り</h3>
            <div className="w-fit flex gap-1 items-center pl-1">
              <span className="py-1 px-2 h-fit rounded-md text-xs font-bold bg-red-300 text-red-800 whitespace-nowrap">急</span>
              <span className="py-1 px-2 h-fit rounded-md text-xs font-bold bg-blue-300 text-blue-800 whitespace-nowrap">作業中</span>
            </div>
          </div>
