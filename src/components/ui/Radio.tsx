...
export function MailRadio({ name, id, onClick, ...props }: mailRadioProps) {
  return (
    <>
      <div data-tooltip-id="mailRadio" data-tooltip-content="メールでの依頼" className="relative aspect-square w-8 h-fit bg-neutral-300 text-neutral-700 rounded-sm overflow-hidden [font-size:0]">
...
export function TelRadio({ name, id, onClick, ...props }: telRadioProps) {
  return (
    <>
      <div data-tooltip-id="telRadio" data-tooltip-content="電話での依頼" className="relative aspect-square w-8 h-fit bg-neutral-300 text-neutral-700 rounded-sm overflow-hidden [font-size:0]">
...
export function OtherRadio({ name, id, onClick, ...props }: otherRadioProps) {
  return (
    <>
      <div data-tooltip-id="otherRadio" data-tooltip-content="打ち合わせ等での依頼" className="relative aspect-square w-8 h-fit bg-neutral-300 text-neutral-700 rounded-sm overflow-hidden [font-size:0]">
